...
public class LongTermParkingPage extends BasePage {
	//final static Logger logger = Logger.getLogger(BasePage.class);

	// Leaving on different day Long-Term Garage Parking  TestCase 1
	public LongTermParkingPage ChooseALot() throws Exception {
		library.clickOnButton(By.id("Lot"));
		System.out.println("clicking");
		return this;
	}

	public LongTermParkingPage selectOption() throws Exception {
		...
		System.out.println("selecting: 'Long-Term Parking' ");
		return this;
	}

	// Choose Entry Date and Time

	public LongTermParkingPage time() throws Exception {
	...
	// choose a date
	public LongTermParkingPage calender() throws Exception {
	...
	public LongTermParkingPage leavingTime() throws Exception {
	...
	public LongTermParkingPage calculateBtn() throws Exception {
