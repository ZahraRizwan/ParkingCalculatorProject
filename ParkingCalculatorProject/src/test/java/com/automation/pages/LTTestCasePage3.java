...
public class LTTestCasePage3 extends BasePage {

//	final static Logger logger = Logger.getLogger(BasePage.class);

	// leaving in a week scenario long term Parking Test case 3

	public LTTestCasePage3 ChooseALot() throws Exception {
		library.clickOnButton(By.id("Lot"));
		System.out.println("clicking");
		return this;
	}

	public LTTestCasePage3 selectOption() throws Exception {
	...
	public LTTestCasePage3 time() throws Exception {
	...
	// choose a date
	public LTTestCasePage3 calender() throws Exception {
	...
	public LTTestCasePage3 leavingTime() throws Exception {
	...
	public LTTestCasePage3 calculateBtn() throws Exception {
