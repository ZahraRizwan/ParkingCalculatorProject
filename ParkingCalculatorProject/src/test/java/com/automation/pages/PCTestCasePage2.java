...
public class PCTestCasePage2 extends BasePage{
	final static Logger logger = Logger.getLogger(BasePage.class);
   
	// leaving on the same day scenario Economy Parking Test case 2 
	
	public PCTestCasePage2 ChooseALot() throws Exception {
		library.clickOnButton(By.id("Lot"));
		System.out.println("clicking");
		return this;
	}

	public PCTestCasePage2 selectOption() throws Exception {
	...
	public PCTestCasePage2 time() throws Exception {
	...
	// choose a date
	public PCTestCasePage2 calender() throws Exception {
	...
	public PCTestCasePage2 leavingTime() throws Exception {
		...
		return this;
           ...
           public PCTestCasePage2 calculateBtn() throws Exception {
