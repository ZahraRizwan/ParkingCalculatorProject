...
public class LTTestCasePage4 extends BasePage {

//	final static Logger logger = Logger.getLogger(BasePage.class);
	   
	// renting for a month scenario long term parking Test case 4 
	
	public LTTestCasePage4 ChooseALot() throws Exception {
		library.clickOnButton(By.id("Lot"));
		System.out.println("clicking");
		return this;
	}

	public LTTestCasePage4 selectOption() throws Exception {
	...
	public LTTestCasePage4 time() throws Exception {
	...
	// choose a date
	public LTTestCasePage4 calender() throws Exception {
	...
	public LTTestCasePage4 leavingTime() throws Exception {
		...
		return this;
           ...
           public LTTestCasePage4 calculateBtn() throws Exception {
