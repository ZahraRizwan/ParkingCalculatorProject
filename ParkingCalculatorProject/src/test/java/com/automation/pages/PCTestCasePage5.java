...
public class PCTestCasePage5 extends BasePage {

	//final static Logger logger = Logger.getLogger(BasePage.class);
	   
	// giving wrong time scenario Economy Parking Test case 5
	
	public PCTestCasePage5 ChooseALot() throws Exception {
		library.clickOnButton(By.id("Lot"));
		System.out.println("clicking");
		return this;
	}

	public PCTestCasePage5 selectOption() throws Exception {
	...
	public PCTestCasePage5 time() throws Exception {
	...
	// choose a date
	public PCTestCasePage5 calender() throws Exception {
	...
	public PCTestCasePage5 leavingTime() throws Exception {
		...
		return this;
           ...
           public PCTestCasePage5 calculateBtn() throws Exception {
